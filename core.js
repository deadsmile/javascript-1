...
(function (context, $, undefined) {
    ...
    var core = context[ LIB_NAME ] || (context[ LIB_NAME ] = {}),
        ...
        /**
         * object 와 배열 모두에서 사용할 수 있는 일반적인 반복 함수이다.<br>
         *     (jquery.each와 차이점은 반복함수의 인자 순서가 다르다.)
         * @function
         * @name emart.each
        ...
        /**
         * 첫번째 인자로 넘어온 객체에 두번째 이후에 넘어온 객체들을 합쳐주는 함수이다.
         * @function
         * @name emart.extend
         * @param {JSON} obj...
         * @returns {*}
...
(function ($, core, ui, undefined) {
    ...
    core.sns = {
        ...
        /**
         * @memberof emart.sns
         * @param type sns 벤더 종류
         * @param params 제목, 링크, 설명, 이미지등
         */
...
(function ($, core, ui, undefined) {
    ...
    // 공통 UI와 관련하여 이벤트 정의
    /**
     * @namespace 글로벌 이벤트 정의
     * @name emart.GlobalUI
     */
    core.GlobalUI = {
        /**
         * 시작함수
         * @memberof emart.GlobalUI
         */
        init: function () {
            if (_isInit) {
                return;
        ...
        /**
         * 탭, 커스텀셀렉트박스, 달력, 플레이스홀더, 아코디온 등의 공통 UI들을 빌드
         * @memberof emart.GlobalUI
         */
        base: function () {
         ...
         * @memberof emart.GlobalUI
         * @example
         * &lt;a href="/modal.html" data-control="modal"&gt;모달&lt;/a&gt;%lt;div class="modal"&gt;...&lt;/div&gt;
         */
        modal: function () {
            // 모달 띄우기
        ...
        /**
         * 버튼에 d-facebook, d-twitter, d-kakaotalk, d-kakaostory 클래스만 추가해주면
         * 해당 벤더에 맞게 공유기능이 붙는다.
         * @memberof emart.GlobalUI
         */
        sns: function () {
...
(function ($, core, ui, undefined) {
    ...
    // 모달이 표시됭 때, 맨 상단으로 스크롤시킨다.
    ui.setDefaults('Modal', {
        events: {
            'modalshow': function () {
    ...
    // 해당요소가 암호필드일 때는 value에 placeholder를 넣지않고,
    // 이미지로 만들어 백그라운드로 처리되는데, 이때 사용할 class명을 설정
    // 즉 user_pw가 추가되면 백그라운드로 placeholder가 표시된다.
    ...
    // 문화센터에서만 사용(ajax로 호출되는 페이지가 인증이 필요할 경우 status를 401로 반환하면 클라이언트에서
    // 로그인 팝업을 띄워준다.)
    $.ajaxSetup({
